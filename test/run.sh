...
check "action: forward"         "$(t aliases '›v7do1zfs8w@proxiedmail.com new@me.com')" "any(i['title']=='Forward to new@me.com' for i in d['items'])"
...
check "actions: quick forwards" "$(t aliases '›v7do1zfs8w@proxiedmail.com ')" "any(i['title']=='Forward to account@example.com' for i in d['items'])"
check "inbox picker"            "$(t inbox '')"              "len(d['items'])==3"
